...
# ../bam/build/bin/nvm-readwrite_stripe-bench --input /mnt/raid0/full/processed/author/node_feat.npy  --queue_depth 1024 --access_type 1 --num_queues 128 --threads 102400 --pages $((1024*1024)) --n_ctrls 2  --ioffset 0
# ../bam/build/bin/nvm-readwrite_stripe-bench --input /mnt/raid0/full/processed/paper/node_feat.npy --queue_depth 1024 --access_type 1 --num_queues 128 --threads 102400 --pages $((1024*1024)) --n_ctrls 2 --ioffset 0 --loffset $((277220883*4096))
